 ...
 */
    ...
    Window_MiniInfo.prototype.drawIcon = function(iconIndex, x, y) {
        ...
        var pw = 32//Window_Base._iconWidth;
        var ph = 32//Window_Base._iconHeight;
        var sx = iconIndex % 16 * pw;
        var sy = Math.floor(iconIndex / 16) * ph;
        var n = 32//Math.floor((this.contents.fontSize / 28) * Window_Base._iconWidth);
                    ...
                    case 11:
						if(DrillUp.m_effect_recoverHP_visible === "true"){
							...
							if(e.value1 > 0 && e.value2 > 0){
								text += g + (e.value1*100).toFixed(DrillUp.m_attr_float_acc) + '%' + "+" + e.value2;
							}else if(e.value1 > 0 && e.value2 == 0 ){
								text += g + (e.value1*100).toFixed(DrillUp.m_attr_float_acc) + '%';
							}else if(e.value2 > 0 && e.value1 == 0){
								text += g + e.value2;
							}else{
								text += c + (e.value1*100).toFixed(DrillUp.m_attr_float_acc) + '%' + "+" + e.value2;
							}
						};
						if(DrillUp.m_effect_lostHP_visible === "true"){
							if(e.value1 < 0 && e.value2 < 0){
								text = s + DrillUp.m_effect_lostHP_text + ':';
								text += r + Math.abs((e.value1*100).toFixed(DrillUp.m_attr_float_acc)) + '%' + "+" + Math.abs(e.value2);
							}else if(e.value1 < 0 && e.value2 == 0 ){
								text = s + DrillUp.m_effect_lostHP_text + ':';
    ...
    Window_MiniInfo.prototype.calcWidth = function() {
        ...
        if (this._item && this._item.name){
            ...
            nw = this.textWidth(name) + ic * (this.standardFontSize() + 24);
        }
    ...
    Window_MiniInfo.prototype.calcHeight = function() {
        return (Math.ceil(this._data.length / this._maxCols) + this.exRow()) * (this.standardFontSize() + 2) + this.standardPadding() * 2 + 32;
    };
    ...
    Window_MiniInfo.prototype.refresh = function() {
        ...
        if (this.exRow()) {
			...
			if(DrillUp.m_window_black === "true"){
				...
				this.contents.fillRect(4, 32/*fs + 15*/, this.contentsWidth() - 8, 8, '#363636'/*this.textColor(DrillUp.iter_color), 120*/);
			}
