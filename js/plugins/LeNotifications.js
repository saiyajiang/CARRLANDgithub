    ...
    if (command === 'Notification') {
        ...
        case 'ResetParameters':
			...
			/*if($gameVariables.value(48) == 0){
			    Lecode.S_Notifs.params.pTextOutlineColor = "#ffffff"
			}
	        if($gameVariables.value(48) == 12){
	            Lecode.S_Notifs.params.pTextOutlineColor = "#3e9ade"
	        }
	        if($gameVariables.value(48) == 31){
	            Lecode.S_Notifs.params.pTextOutlineColor = "#c080ff"
	        }
	        if($gameVariables.value(48) == 27){
	            Lecode.S_Notifs.params.pTextOutlineColor = "#f100f1"
	        }
	        if($gameVariables.value(48) == 14){
	            Lecode.S_Notifs.params.pTextOutlineColor = "#ffcc20"
	        }*/
            Lecode.S_Notifs.params.pTextOutlineColor = String(Lecode.parameters['Text Outline Color'] || '#');
            Lecode.S_Notifs.params.pTextOutlineWidth = Number(Lecode.parameters['Text Outline Width'] || 0);
            break;
