...
/*:
 * @plugindesc (v1.2)[v1.5]  主菜单 - 全自定义主菜单
 ...
 *   游戏时长数值、所在地图名称
 *
 * （当然，如果一定要隐藏，设置Y坐标1000以上，让玩家看不到就可以了。）
 *
 * -----------------------------------------------------------------------------
 * ----素材规则
 * 这里固定设置了生命条是流动的。
 ...
 * 资源-怒气条    （menus_main文件夹）
 * 资源-怒气数值  （menus_main文件夹）
 * 资源-经验条    （menus_main文件夹）
 * 资源-经验数值  （menus_main文件夹）
