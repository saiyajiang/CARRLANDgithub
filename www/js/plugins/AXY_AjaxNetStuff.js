...
//=============================================================================
/*:
 * @plugindesc v1.32 This plugin support rmmv with ajax net stuff.
...
if (AXY.AjaxNetStuff.Param.EnableVerCheck) {
	...
	var AXYAjaxVerCheckTemplateStyle2 =
		...
		parseInt(AXY.AjaxNetStuff.Parameters['zIndex']) + ";color:" +
		String(AXY.AjaxNetStuff.Parameters['VerCheckTextColor']) + ";}<\/style>";
					...
					if (parseFloat(AXY.AjaxNetStuff.Param.VerCloud) <= parseFloat(AXY.AjaxNetStuff.Param.VerLocal)) {
						...
						if (AXY.AjaxNetStuff.Param.EnableVerCheckNotice) {
							...
							$('.AXYAjaxVerCheck2').html('' +
								'<div class="modal fade" id="AXYAjaxVerCheckModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">' +
								...
								'        <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="AXYAjaxVerCheckHaveNewbtn_close">' +
	...
	var AXY_AjaxLogin = {
		show: function () {
			...
			var AXYAjaxLoginTemplate =
				...
				'<input type="button" class="AXYAjaxLoginButton" id="AXYAjaxLoginButtonClose" value="关闭" />' +
				'</div>-->' +
				'<div class="modal fade" id="AXYAjaxLogin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">' +
				...
				'</div>' +
				'<div class="form-group">' +
				'<label for="AXYAjaxLoginInputAutoLogin" class="col-form-label">自动登录:</label>' +
				'<input type="checkbox" class="form-control AXYAjaxLoginInput;" id="AXYAjaxLoginInputAutoLogin" />' +
				'</div>' +
				'</form>' +
				'</div>' +
				'<div class="modal-footer">' +
			...
			var AXYAjaxLoginStyleCss =
				'.bg-black-transparent{background-color:' + AXY.AjaxNetStuff.Param.LoginModalBgColor + ';color:' + AXY.AjaxNetStuff.Param.LoginModalTextColor + ';opacity:' + AXY.AjaxNetStuff.Param.LoginModalOpacity + ';font-family:' + ($gameSystem ? Window_Base.prototype.standardFontFace : 'GameFont') + '}' +
