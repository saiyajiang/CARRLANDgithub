...
//=============================================================================
/*:
 * @plugindesc (v1.1)[v1.0]  画面 - 道具浮动文字
 ...
 * -----------------------------------------------------------------------------
 * ----相似插件
 * 该插件与MOG_TreasureHud.js 画面-道具浮动框 的功能是一样的。
...
TreasureIcons.prototype.refreshIcon = function() {
	var w = 0/*Window_Base._iconWidth*/;
	var h = 0/*Window_Base._iconHeight*/;
...
TreasureIcons.prototype.refreshName = function() {
	...
	var name = this._item ? this._item.name + " x " + this._amount : "金币 x " + this._amount;
	

    //this.setItemTextColor();
	if($gameVariables.value(48) == 0){
	$gameVariables.setValue(48,0)
	this._name.bitmap.textColor = "#ffffff"
	
	}
	if($gameVariables.value(48) == 12){
	$gameVariables.setValue(48,0)
	this._name.bitmap.textColor = "#3e9ade"
	
	}
	if($gameVariables.value(48) == 31){
		$gameVariables.setValue(48,0)
	this._name.bitmap.textColor = "#c080ff"
	
	}
	if($gameVariables.value(48) == 27){
		$gameVariables.setValue(48,0)
	this._name.bitmap.textColor = "#f100f1"
	
	}
	if($gameVariables.value(48) == 14){
		$gameVariables.setValue(48,0)
	this._name.bitmap.textColor = "#ffcc20"
	
	}
	if($gameVariables.value(48) == 10){
		$gameVariables.setValue(48,0)
	this._name.bitmap.textColor = "#ff3810"
	
	}
	this._name.bitmap.drawText(name,0,0,0,32);
